...
if [[ -z "${Vless_Path}" ]]; then
  Vless_Path="/fd85790e-d4de-479b-90f0-5b07c23c8c54"
fi
echo ${Vless_Path}

if [[ -z "${Vless_UUID}" ]]; then
  Vless_UUID="fd85790e-d4de-479b-90f0-5b07c23c8c54"
fi
echo ${Vless_UUID}

if [[ -z "${Vmess_Path}" ]]; then
  Vmess_Path="/b9f6a985-a576-4bca-94ed-983354662e40
fi
echo ${Vmess_Path}

if [[ -z "${Vmess_UUID}" ]]; then
  Vmess_UUID="b9f6a985-a576-4bca-94ed-983354662e40"
fi
echo ${Vmess_UUID}
